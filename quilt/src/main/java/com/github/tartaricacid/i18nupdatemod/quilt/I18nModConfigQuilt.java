...
public class I18nModConfigQuilt implements ConfigData {
    public static String downloadLink = "https://gitcode.net/chearlai/translationpackmirror/-/raw/main/files";
    public static String resourcePackName = "Minecraft-Mod-Language-Modpack-1-19-Fabric";
    public static String md5Name = "1.19-fabric";
}
